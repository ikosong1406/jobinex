  ...
  const steps = [
    {
      ...
      description:
        "UK professionals: Outsource your job applications. Nigerian freelancers: Sign up to access international gigs. One platform, two powerful paths.",
    },
    {
    ...
    },
    {
      ...
      description:
        "UK clients: Our assistants submit applications for you. Nigerian talent: Get hired and deliver projects — we handle payments in NGN.",
    },
    {
      icon: <FaBriefcase className="text-purple-500" size={28} />,
      title: "4. Success on Both Ends",
      description:
        "Users land interviews without lifting a finger. Nigerians earn fair wages paid locally. Everyone wins.",
    },
  ];
  ...
  return (
    <section className="bg-white text-gray-800 py-20 px-4 md:px-16">
      <div className="max-w-6xl mx-auto text-center mb-12">
        ...
        >
          Whether you're in UK looking to save time or in Nigeria seeking
        ...
        <div className="flex justify-center gap-4 mt-4">
          <span className="bg-blue-100 text-blue-700 px-4 py-1 rounded-full text-sm font-medium flex items-center gap-1">
            <FaBriefcase size={14} /> UK Job Seekers
          </span>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-10">
        ...
        >
          <img
            ...
            alt="Jobbinex dual marketplace connecting UK and Nigeria"
